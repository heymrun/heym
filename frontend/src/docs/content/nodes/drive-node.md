...
Format conversion moved to the [Converter](./converter-node.md) node. Store or fetch the file with Drive, then hand its id to a converter node:
...
- [Converter Node](./converter-node.md) - Convert a stored file to another format, or OCR it to text
