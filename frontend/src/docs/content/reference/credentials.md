...
| [Cal.com](../nodes/cal-node.md) | Cal.com API | Cal.com API v2 webhook operations |
| [Cal.com Trigger](../nodes/cal-trigger-node.md) | Cal.com Trigger (Webhook Secret) | Incoming webhook HMAC-SHA256 verification |
