...
| AI workflow migration / Convert | ✓ | limited¹⁸ | limited¹⁸ | limited¹⁸ |
...
## AI Convert: Migrate Existing Workflows

Heym's [AI Convert](./migrate-to-heym.md) tool turns existing automation assets into native Heym workflows. Paste an exported workflow from n8n, Flowise, Dify, Langflow, sim.ai, or Activepieces — or describe the workflow in plain language — and Heym previews the generated graph on a live canvas before you download and import it.

This is different from ordinary import/export. [n8n workflow JSON](https://docs.n8n.io/workflows/export-import/), [Zapier Zap JSON](https://help.zapier.com/hc/en-us/articles/8496308481933-Import-and-export-Zap-workflows-in-your-Team-or-Enterprise-account), and [Make.com scenario blueprints](https://help.make.com/blueprints) all support moving workflows inside their own ecosystems, but their public docs describe same-platform portability, not AI-assisted cross-platform migration. Heym uses conversion as an onboarding primitive: bring the shape of the old workflow, map it to native Heym nodes, then continue editing it on the same canvas as any other workflow.
