...
function getDefaultNodeData(type: NodeType): WorkflowNode["data"] {
  const defaults: Record<NodeType, WorkflowNode["data"]> = {
    ...
    notion: { label: "notion", credentialId: "", notionOperation: undefined, notionQuery: "", notionPageId: "", notionDataSourceId: "", notionParentPageId: "", notionBlockId: "", notionProperties: "{}", notionChildren: "[]", notionFilter: "{}", notionSort: "{}", notionSorts: "[]", notionIcon: "{}", notionCover: "{}", notionPageSize: "100", notionStartCursor: "", notionAfterBlockId: "" },
